...
import node.aiNode.ImageStyleTransfer.src.transform as transform
import node.aiNode.ImageStyleTransfer.src.vgg as vgg
import scipy.misc
import tensorflow as tf
from node.aiNode.ImageStyleTransfer.src.utils import save_img, get_img, exists, list_files
...
def process_image(image_path, output_path, model_path):
    ffwd_to_img(image_path, output_path, model_path,
                device=DEVICE)
